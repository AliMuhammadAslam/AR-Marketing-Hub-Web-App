                        ...
                        <div className="column-4 col-md-3 col-sm-6">
                            ...
                            <ul className='list-unstyled'>
                                ...
                                <div className='logo-container'>
                                    <a className='icon-FB' href="/" ><MdFacebook /></a>
                                    <a className='icon-Tw' href="/" ><FaTwitter /></a>
                                    <a className='icon-YT' href="/" ><FaYoutube /></a>
                                    <a className='icon-Ig' href="/" ><FaInstagram /></a>
                                    <a className='icon-Pi' href="/" ><FaPinterest /></a>
                                    <a className='icon-Li' href="/" ><FaLinkedin /></a>
                                </div>
                            </ul>
