            ...
            <div className="register-form">
                <div className="auth-form-container">
                    ...
                    <form className="register-form" onSubmit={handleSubmit}>
                        <div className="name-label" style={{ marginLeft: "-5rem" }}>
                        ...
                        <input
                            ...
                            required
                        />
                        <div className="email-label" style={{ marginLeft: "-5rem" }}>
                        ...
                        <input
                            ...
                            required
                        />
                        <div className="pass-label" style={{ marginLeft: "-3.5rem" }}>
                ...
                <div>
                    <Nav.Link as={Link} to="/signin">
                        <button className="link-btn" type="button">
                            Already have an account? <span style={{ color: "#003366" }}> Log In</span>
                        </button>
                    </Nav.Link>
                </div>
            </div>
